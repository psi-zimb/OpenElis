    ...
    protected ActionForward performAction(ActionMapping mapping,
        ...
        try {
            ...
            if (FWD_NEXT.equals(direction)) {
                ...
                List typeOfTestStatuses = typeOfTestStatusDAO.getNextTypeOfTestStatusRecord(typeOfTestStatus.getDescription());
            ...
            if (FWD_PREVIOUS.equals(direction)) {
                //bugzilla 1427 pass in name not id
                List typeOfResultStatuses = typeOfTestStatusDAO.getPreviousTypeOfTestStatusRecord(typeOfTestStatus.getDescription());
