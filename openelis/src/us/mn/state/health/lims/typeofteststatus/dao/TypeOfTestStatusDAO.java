...
public interface TypeOfTestStatusDAO extends BaseDAO {
	...
	public void deleteData(List typeOfTestStatuses) throws LIMSRuntimeException;
	...
	public TypeOfTestStatus getTypeOfTestStatusByName(String typeOfResultStatusName) throws LIMSRuntimeException;

    public TypeOfTestStatus getTypeOfTestStatusById(String resultTypeId) throws LIMSRuntimeException;
